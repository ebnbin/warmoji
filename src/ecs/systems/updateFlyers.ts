...
import { airborne, catchFlyer } from '../ability/kinds/boomerang'
import { DEG2RAD } from '../../util/units'
import type { BoomerangDef } from '../../types/abilityDefs'
import { AbilityRef, Cooldown, Flyer, Frozen, Transform } from '../components'
import { flyerHits } from '../store'
import { cooldownMul, damageTarget, ownerX, ownerY } from '../ability/amp'
