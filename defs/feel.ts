...
export const FEEL = {
  ...
  squad: { fanDistance: 1.5, fanSpreadDeg: 120, seatRadius: 0.125, claimRadius: 0.5, seatHysteresis: 0.25, ghostSpeed: 10, reverseGain: 2, repelRadius: 1, repelForce: 40, recallDist: 14 },
