...
import { Alive, ENEMY_SET, EProj, EPROJ_SET, Hurt, Iframe, Proj, PROJ_SET, Radius, Transform, Vel } from './components'
...
// 抛射物的逐帧推进:线段扫掠命中(pierce + 击退 + onHit 效果链),按视野/寿命回收。
// 敌弹另走圆-圆命中队员(吃无敌帧)。生成在 entities/projectile.ts。
