...
import { Alive, Casting, Clock, Depth, Drive, Faction, Hp, Mark, Phys, Radius, Rushing, Slowed, Sprite, Tint, Transform, VisOff } from '../components'
...
export function spawnBody(world: EcsWorld, spec: BodySpec): number {
  ...
  addComponents(world, eid, Alive, Hp, Mark, Phys, Drive, Clock, Faction, Radius, Rushing, Slowed, Casting, Transform, Sprite, Tint, Depth, VisOff)
  Alive.v[eid] = 1
  Hp.v[eid] = spec.hp
  Hp.max[eid] = spec.hp
