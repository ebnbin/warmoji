...
import { Alive, Casting, Clock, Ctl, Depth, Drive, Faction, Hp, Mark, Motion, MotionHit, Phys, Radius, SpeedMul, Sprite, Tint, Transform, VisOff } from '../components'
...
export function spawnBody(world: EcsWorld, spec: BodySpec): number {
  ...
  addComponents(world, eid, Alive, Hp, Mark, Phys, Drive, Clock, Faction, Radius, Motion, MotionHit, Ctl, SpeedMul, Casting, Transform, Sprite, Tint, Depth, VisOff)
  Alive.v[eid] = 1
  Hp.v[eid] = spec.hp
  Hp.max[eid] = spec.hp
