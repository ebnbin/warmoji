...
import { BOSS, CAPTAINS, CHARACTERS, COIN, ENEMY_SPECS, WAVE } from '../config'
...
import { burstEmitter } from '../battle/fx'
import { FONT, UI_FONT } from '../lib/fonts'
import { playSfx } from '../audio/sfx'
import { applyCamera, textRes, viewport, VIEWPORT_CHANGED } from '../screen/apply'
